...
import { getSelectedAuthorableStateByKey } from "@/editor/state/editor/selectors/get-selected-authorable-state-by-key";
...
const Option: React.FC<OptionProps> = ({
  ...
  const selectedAuthorableStateByKey = useEditorStore((state: IEditorState) =>
    getSelectedAuthorableStateByKey(state, authorablePropKey),
  );
