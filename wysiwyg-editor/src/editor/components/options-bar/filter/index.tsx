...
import { getSelectedAuthorableProps } from "@/editor/state/editor/selectors/get-selected-authorable-props";
...
const OptionsFilter: React.FC = () => {
  ...
  const setSelectedAuthorableStateFilter = useEditorStore(
    setSelectedAuthorableStateFilterAction,
  );
  const selectedAuthorableStateFilter = useEditorStore(
        ...
        Object.keys(selectedAuthorableProps)
          .map((selectedAuthorablePropKey) => {
            const selectedAuthorableProp =
              selectedAuthorableProps[selectedAuthorablePropKey];
      ...
      <FlexItem>
        <FormControl size="small" fullWidth>
          ...
          <Select
            ...
            id="filter"
            value={selectedAuthorableStateFilter ?? ""}
            label="Filter"
            onChange={onChange}
          >
