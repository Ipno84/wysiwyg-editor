...
const InputText: React.FC<OptionProps> = ({ authorableProp, authorablePropKey, index, onOptionChange, value, leafValue }) => {
    ...
    console.log(authorablePropKey, value, leafValue, authorableProp.default);
