...
const ButtonComponent = forwardRef<HTMLButtonElement | null, ButtonOwnProps>((props, ref) => <MuiButton {...props} ref={ref} />);
...
const authorableProps: AuthorableProps = {
    ...
    disabled: {
        ...
        default: false,
        label: 'Disabled',
        description: 'Tick if you want to disable the button',
        required: false,
        group: {
            label: 'Behavior',
            value: 'behavior',
    ...
    disableElevation: {
        ...
        description: 'Tick if you want to disable the button elevation',
        required: false,
        group: {
            label: 'Appearance',
            value: 'appearance',
    ...
    disableFocusRipple: {
        ...
        description: 'Tick if you want to disable the button focus ripple',
        required: false,
        group: {
            label: 'Appearance',
            value: 'appearance',
    ...
    fullWidth: {
        ...
        default: false,
        label: 'Full Width',
        description: 'Tick if you want the button to take up the full width of its container',
        required: false,
        group: {
            label: 'Appearance',
            value: 'appearance',
