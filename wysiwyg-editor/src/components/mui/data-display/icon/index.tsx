...
const IconComponent = forwardRef<SVGSVGElement | null, IconOwnProps & { muiName?: keyof typeof Icons }>((props, ref) => {
...
const authorableProps: AuthorableProps = {
    ...
    fontSize: {
        ...
        multiple: false,
        label: 'Font Size',
        description: 'Select the font size',
        required: false,
        options: [
            { label: 'Inherit', value: 'inherit' },
    ...
    muiName: {
        ...
        multiple: false,
        label: 'Icon Name',
        description: 'Choose the icon name',
        required: false,
