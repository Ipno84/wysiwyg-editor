...
const GridContainerComponent = styled(ViewComponent)<GridContainerProps>(({ $columns = 6, $gap, $breakpoints }) => {
    let style: CSSObject = {
        display: 'grid',
        ...
        Object.entries($breakpoints).forEach(([breakpoint, props]) => {
            ...
            style = {
                ...
                [breakpointKey]: {
                    ...
                    gridTemplateColumns: props.$columns !== undefined ? `repeat(${props.$columns}, 1fr)` : undefined,
